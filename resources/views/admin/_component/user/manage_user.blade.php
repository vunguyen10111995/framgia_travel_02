                            ...
                            <tbody>
                                ...
                                <tr class="value-users {{$user->id}}">
                                    ...
                                    @if(Auth::user()->id == $user->id)
                                        <td>
                                            <a class="change_level" value="{{ $user->level }}" data="{{ $user->id }}"></a>{{ ($user->level == config('setting.level.guide')) ? trans('admin.guide') : ($user->level == config('setting.level.admin') ? trans('admin.admin') : trans('admin.user')) }}
                                        </td>
                                        <td>
                                            <a class="change_permission" value="{{ $user->status }}" data="{{ $user->id }}"></a> {{ ($user->status == config('setting.status.inprogress')) ? trans('admin.inprogress') : trans('admin.approved') }}
                                        </td>
                                    @else
                                        <td>
