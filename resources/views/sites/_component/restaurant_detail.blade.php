    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-1">
                ...
                {!! Form::text('description', $restaurant->province->name, ['class' => 'form-control']) !!}
                {!! Form::label('price', trans('site.price')) !!}
                {!! Form::text('price', $restaurant->price, ['class' => 'form-control']) !!}
                {!! Form::label('rate', trans('site.rate')) !!}
                {!! Form::text('rate', $restaurant->rate, ['class' => 'form-control']) !!}
            </div>
            <div class="col-sm-4">
                {!! Form::label('description', trans('site.description')) !!}
                <div class="form-group">
                    {!! Form::text('description', $restaurant->description, ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
    </div>
