...
<section class="whiteSection">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="sectionTitle">
                    <h2><span>{{ trans('site.restaurants') }}</span></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
        ...
        <div class="row isotopeContainer">
            @foreach($categories->services as $restaurant) 
                <div class="col-sm-4 isotopeSelector asia">
                    <article class="">
                        <figure>
                            <img src="{{ $restaurant->image }}" alt="" height="300px">
                            <h4>{{ $restaurant->name }}</h4>
                            <div class="overlay-background">
                                <div class="inner"></div>
                            </div>
                            <div class="overlay">
                                <a class="fancybox-pop" href="{{ route('restaurant.detail', $restaurant->id) }}">
                                    <div class="overlayInfo">
                                        <h5><span>{{ $restaurant->price }}</span></h5>
                                        <p><i class="fa fa-calendar" aria-hidden="true"></i>{{ substr($restaurant->description, 0, 20) }}...</p>
                                    </div>
                                </a>
                            </div>
                        </figure>
